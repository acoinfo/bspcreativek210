...
static VOID  *pthread_test(VOID  *pvArg)
{
    ...
    fft_complex_uint16_dma(DMAC_CHANNEL0, DMAC_CHANNEL1, FFT_DIR_FORWARD, buffer_input, FFT_N, buffer_output);
    ...
    fft_complex_uint16_dma(DMAC_CHANNEL0, DMAC_CHANNEL1, FFT_DIR_BACKWARD, buffer_input, FFT_N, buffer_output);
    ...
    printf("[hard fft test] [%d bytes] forward time = %lld us, backward time = %lld us\n",
            FFT_N,
    ...
    printf("[soft fft test] [%d bytes] forward time = %lld us, backward time = %lld us\n",
            FFT_N,
