...
static VOID  *pthread_test(VOID  *pvArg)
{
    ...
    int              num   = 0;
    char            *tag   = "1234567890 1234567890 1234567890 1234567890 1234567890 1234567890\n";
    char             input[RECV_BUF_LEN] = {0};
    ...
    num = read(iFd, input, RECV_BUF_LEN);
    input[num] = '\0';
    printf("read[%d]: %s\n", num, input);
